<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Phonegap._Default" %>
...
<html>
<head>
<title>Profession a Corporate Business Category Flat bootstrap Responsive  Website Template | Home :: w3layouts</title>
<link href="css/bootstrap.css" rel="stylesheet" type="text/css" media="all">
<link href="css/style.css" rel="stylesheet" type="text/css" media="all" />
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Profession Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li class="active"><a href="index.html">Hoteles <span class="sr-only">(current)</span></a></li>
								<li><a href="" class="scroll">Restaurantes</a></li>
								<li><a href="" class="scroll">Hecas</a></li>
								<li><a href="Tourvirtual.html" >Rutas Virtuales</a></li>
								<li><a href="" class="scroll">Eventos</a></li>
				...
				<div class="header-bottom">
					<div class="navbar-brand">
						<h1><a href="index.html">Ibarra Móvil</a></h1>
					</div>
				</div>
			</div>
		</div>	
<!--header-->
	...
	<div class="banner-section">
		<div class="slider">
							...
							<div class=" col-md-4 filtr-item" data-category="1, 5" data-sort="Busy streets">
								<a href="images/pc.jpg" class="b-link-stripe b-animate-go  swipebox">
									<div class="ed-gal-effect slow-zoom horizontal">
										<div class="img-box"><img src="images/pc.jpg"  class="img-responsive" alt=" " /></div>
					...
					<div class="container">
						<div class="what-grids">
							...
							<div class="col-md-6 bar-grid">
								...
								<div class='bar_group'>
									<div class='bar_group__bar thin' label='Wordpress' show_values='true' tooltip='true' value='343'></div>
									<div class='bar_group__bar thin' label='Joomla' show_values='true' tooltip='true' value='235'></div>
									<div class='bar_group__bar thin' label='Drupal' show_values='true' tooltip='true' value='975'></div>
									<div class='bar_group__bar thin' label='Magento' show_values='true' tooltip='true' value='456'></div>
								</div>
					...
					<div class="container">
						...
						<div class="news-grids wow fadeInRight animated" data-wow-delay=".5s">
							...
							<div class="col-md-8 new-grid1 hvr-bounce-to-right">
								...
								<h4><a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">Fusce euismod consequat ante Lorem ipsum dolor sit amet</a></h4>
			...
			<!---news--->
			<div class="testimonials wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s" id="testimonials">
				<div class="container">
			...
			<div class="contact" id="contact">
				<div class="container">
					...
					<div class="google-map">
						<iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d6398505.919415653!2d-108.11118536884915!3d38.45831521749536!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1soil+industry+in+usa!5e0!3m2!1sen!2sin!4v1458365833408" ></iframe>
					</div>
				</div>
			</div>
			<!--footer-->
			<div class="copy-section">
				<div class="container">
					<div class="footer-top">
						<p>&copy; 2016 Profession. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
					</div>
				</div>
			</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<div class="news-gr">
							<img src="images/pc1.jpg" class="img-responsive" />
							<h3 class="tittle1">Profession</h3>
